...
const int LineNumber = 5000;//插入数据的个数
...
//实验内容4.3
const int DistanceTypeTestQueryNumber = 1000;//不同距离函数性能测试时的查询个数
...
const QString DistanceTypeTestQueryFile = "data/query_"+QString::number(Dimension)+"_"+QString::number(DistanceTypeTestQueryNumber)+".txt";//实验内容4.3中knn查询输入文件
